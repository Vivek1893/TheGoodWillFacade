...
const ServicesAllInOne = () => {
  const servicesIcons = [
    {
      icon: <img src="/lo.png" alt="ACP Cladding" className="h-14 w-14 object-contain" />,
      title: "ACP Cladding",
      description:
        "ACP Cladding (Aluminium Composite Panel Cladding) is widely used in modern architecture for its durability, lightweight nature, and elegant appearance.",
    },
    {
      icon: <img src="/lo.png" alt="Aluminum Windows" className="h-14 w-14 object-contain" />,
      title: "Aluminum Windows",
      description:
    ...
    {
      icon: <img src="/lo.png" alt="MS Structure" className="h-14 w-14 object-contain" />,
      title: "MS Structure",
      description:
    ...
    {
      icon: <img src="/lo.png" alt="Railings" className="h-14 w-14 object-contain" />,
      title: "Railings",
      description:
    ...
    {
      icon: <img src="/lo.png" alt="Stone Cladding" className="h-14 w-14 object-contain" />,
      title: "Stone Cladding",
      description:
    ...
    {
      icon: <img src="/lo.png" alt="Structural Glazing" className="h-14 w-14 object-contain" />,
      title: "Structural Glazing",
      description:
    ...
    {
      icon: <img src="/lo.png" alt="Skylight" className="h-14 w-14 object-contain" />,
      title: "Skylight",
      description:
    ...
    {
      icon: <img src="/lo.png" alt="Tensile Fabrics" className="h-14 w-14 object-contain" />,
          ...
          <div className="text-center mb-16 md:mb-20">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 mb-4">
                Expert <span className="font-bold text-blue-900">Facade Solutions</span>
              </h2>
            </motion.div>
            ...
            >
              Delivering precision-engineered architectural solutions that combine innovative design with uncompromising quality and durability.
            </motion.p>
          </div>
          ...
          >
            {servicesIcons.map((service, index) => (
              ...
              >
                ...
                {/* Content */}
                <div className="relative z-10">
                  <div className="mb-6 p-3 bg-gradient-to-br from-blue-50 to-orange-50 rounded-lg w-16 h-16 flex items-center justify-center group-hover:from-blue-100 group-hover:to-orange-100 transition-all duration-500">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-4 border-t border-gray-100 group-hover:border-orange-200 transition-colors duration-300">
                      <div className="flex items-center text-sm font-bold text-gray-900 group-hover:text-orange-500 transition-colors duration-300">
