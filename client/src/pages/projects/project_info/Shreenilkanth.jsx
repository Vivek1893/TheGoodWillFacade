...
const shreenilkanth = () => {
  ...
  const designImages = [
    "/project_detail_img/SHREE NILKANTH BUSS HUB 11 (1).webp",
    "/project_detail_img/SHREE NILKANTH BUSS HUB 11 (1).webp",
    "/project_detail_img/SHREE NILKANTH BUSS HUB 11 (1).webp",
  ];
  ...
  return (
    <section className="w-full bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen">
      ...
      <div className="w-full font-sans text-center py-16 px-4">
        ...
        >
          SHREENLKANTH <span className="text-blue-600">PLATINUM</span>
        </motion.h1>
        <motion.p 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      <div className="flex flex-col lg:flex-row items-start justify-center gap-8 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto mb-20">
        ...
        <div className="w-full lg:w-1/2 flex flex-col">
          <motion.div 
            ...
            onClick={() => openImageModal("/project_detail_img/SHREE NILKANTH BUSS HUB 11 (1).webp")}
          >
            <img
              src="/project_detail_img/SHREE NILKANTH BUSS HUB 11 (1).webp"
              alt="Godrej Platinum"
