    ...
    <div className="w-full font-sans">
      ...
      <div className="relative w-full h-[85vh]">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black/40">
          <h1 className="text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-yellow-300 to-blue-900 tracking-wide drop-shadow-lg animate-fadeIn">
            AluminumWindows
          </h1>
        </div>
      </div>
      ...
      <section className="px-6 md:px-20 py-20 bg-white">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
          Why Choose <span className="text-orange-600">AluminumWindows</span>
        </h2>
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group">
            ...
            <div className="absolute inset-0  p-4">
              <p className="text-white font-medium">Modern ACP Installation</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 md:px-20 py-20 bg-gray-50">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
          Sample Designs for <span className="text-blue-800">AluminumWindows</span>
        </h2>
      ...
      <section className="px-6 md:px-20 py-20 bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white">
        ...
        <div className="grid md:grid-cols-4 gap-10 text-center">
          ...
          <div className="p-6 bg-white/10 rounded-xl backdrop-blur-sm hover:shadow-lg transition">
            <h3 className="font-semibold text-lg mb-4">300+ Shade Options</h3>
            <p className="text-sm">
