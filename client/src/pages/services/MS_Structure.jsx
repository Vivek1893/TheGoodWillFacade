    ...
    <div className="w-full font-sans">
      ...
      <section className="px-6 md:px-20 py-20 bg-white">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
          Why Choose <span className="text-orange-600"> MSStructure</span>
        </h2>
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group">
            ...
            <div className="absolute inset-0  p-4">
              <p className="text-white font-medium"> MSStructure</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 md:px-20 py-20 bg-gray-50">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-gray-800">
          Sample Designs for <span className="text-blue-800"> MSStructure</span>
        </h2>
