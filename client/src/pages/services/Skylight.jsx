    ...
    <div className="w-full font-sans bg-white">
            ...
            >
              ...
              <div className="relative rounded-tl-4xl rounded-br-4xl  overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                  <p className="text-white font-medium text-lg">Modern Skylight Installation</p>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="px-4 md:px-8 lg:px-16 py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            Simple Design for <span className="text-blue-800">Skylight</span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0 }}
          ...
          >
            Explore our portfolio of innovative Skylight solutions
          </motion.p>
