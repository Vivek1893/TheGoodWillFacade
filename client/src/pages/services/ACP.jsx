...
const ACPCladding = () => {
  ...
  const designImages = [
    "/servicesimg/acp_img/project1.jpg",
    "/servicesimg/acp_img/project2.JPG",
    "/servicesimg/acp_img/project3.jpg",
    "/servicesimg/acp_img/project4.jpg",
    "/servicesimg/acp_img/project5.jpg",
    "/servicesimg/acp_img/project6.jpg",
    "/servicesimg/acp_img/project7.jpg",
    "/servicesimg/acp_img/project8.jpg",
  ];
    ...
    <div className="w-full font-sans bg-white">
      ...
      <section className="px-4 md:px-8 lg:px-16 py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            Explore our portfolio of innovative ACP cladding solutions
          </motion.p>
